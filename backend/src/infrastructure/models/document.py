...
class Document(Base):
    ...
    filename: Mapped[str] = mapped_column(String(255), nullable=False, default="Название файла")
    ...
    collection_name: Mapped[str] = mapped_column(String(100), nullable=True, default="project_docs") 
