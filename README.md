...
- **Команда DocuWeave** - Разработка и поддержка
- **Сообщество** - Тестирование, обратная связь, вклад в код

## 🙏 Благодарности

- Разработчикам [LangChain](https://github.com/langchain-ai) и [LangGraph](https://github.com/langchain-ai/langgraph) за потрясающие инструменты
- Команде [Ollama](https://ollama.ai/) за возможность локального запуска LLM
- Сообществу [FastAPI](https://fastapi.tiangolo.com/) за отличный фреймворк
